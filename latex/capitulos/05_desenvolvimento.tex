...
O Algoritmo \ref{lst:poda_opacidade} apresenta a lógica central. O código executável e os relatórios de artefato permanecem versionados no repositório; o pseudocódigo descreve somente o procedimento relevante para a validade da comparação.
...
O código-fonte completo dos procedimentos próprios permanece versionado no repositório. Na versão final, os trechos estritamente necessários à reprodução poderão ser reunidos em apêndice, identificado como material elaborado pelo autor. O texto principal mantém o foco na arquitetura, nas decisões e nas consequências metodológicas da implementação.
